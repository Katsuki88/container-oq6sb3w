...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oq6sb3w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oq6sb3w.containers.anotherwebservice.com/
...
```
git clone git@github.com:Katsuki88/container-oq6sb3w.git
cd container-oq6sb3w
```
...
```
docker attach container-oq6sb3w
```
